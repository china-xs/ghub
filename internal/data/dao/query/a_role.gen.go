...
func newRole(db *gorm.DB) role {
	...
	_role.PID = field.NewInt32(tableName, "p_id")
	_role.Nodes = field.NewString(tableName, "nodes")
	_role.Name = field.NewString(tableName, "name")
	_role.Desc = field.NewString(tableName, "desc")
	_role.OperateID = field.NewInt32(tableName, "operate_id")
...
func (r *role) updateTableName(table string) *role {
	...
	r.PID = field.NewInt32(table, "p_id")
	r.Nodes = field.NewString(table, "nodes")
	r.Name = field.NewString(table, "name")
	r.Desc = field.NewString(table, "desc")
	r.OperateID = field.NewInt32(table, "operate_id")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["nodes"] = r.Nodes
	r.fieldMap["name"] = r.Name
	r.fieldMap["desc"] = r.Desc
	r.fieldMap["operate_id"] = r.OperateID
